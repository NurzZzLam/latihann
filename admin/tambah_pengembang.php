...
include '../koneksi.php';
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "INSERT INTO pengembang (id_pengembang, nama_pengembang, alamat, nomor_telepon) VALUES ('','$nama', '$alamat', '$nomor')";
...
<div class="container-fluid">
  ...
  ?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2> Tambah Data Pengembang</h2>
      <form method="POST" action=""> 
    <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Nama Pengembang</label>
        <input type="text" name="nama_pengembang" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="nomor_telepon" class="form-control" id="exampleInputPassword1" required> 
    </div>
    <div class="d-flex">    
